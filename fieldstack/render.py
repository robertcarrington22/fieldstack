...
<footer>Generated by Fieldstack from Procore records as of {facts.as_of.isoformat()}. Every figure above is computed from the source record cited; the narrative is drafted from those figures only. {backend_note}</footer>
</div></body></html>"""
